                ...
                <CardContent className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">123 Juice Street, Healthy City, HC 12345</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">hello@juicevibe.com</p>
                      <p className="text-muted-foreground">support@juicevibe.com</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
